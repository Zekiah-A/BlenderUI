...
if  g++ main.cpp main.hpp rect.cpp rect.hpp checkbox.cpp checkbox.hpp -o blender_ui button.cpp button.hpp textlabel.cpp textlabel.hpp -lGL -lGLU -lglut; then # turn up verbosity
